...
export default function commentCard() {
    return (
        ...
        <div className=' flex flex-col  w-full max-w-screen-md mb-8 mx-4 divide  ' >
            ...
            <img src='connetbitcoin.jpg' alt='post' className=' object-center object-contain max-h-screen mt-2 rounded-2xl border border-gray-100 dark:border-gray-700' />
